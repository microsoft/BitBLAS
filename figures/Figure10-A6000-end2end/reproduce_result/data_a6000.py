...
llama2_times_data = [
    ...
    ("Ladder", [2.4559, 2.5785, 66.4663]),
    ("Ladder-W$_{INT4}$A$_{FP16}$", [0.657948069, 1.185360816, 64.75624679]),
    ("Ladder-W$_{NF4}$A$_{FP16}$", [0.681704869, 1.338692052, 66.25319969]),
    ("Ladder-W$_{FP8}$A$_{FP8}$", [1.256130442, 1.475792808, 64.78081631]),
    ("Ladder-W$_{MXFP8}$A$_{MXFP8}$", [1.342351263, 1.789379982, 82.90916215]),
    ("Ladder-W$_{INT1}$A$_{INT8}$", [0.209039266, 0.752349635, 41.1277536]),
]
...
bloom_times_data = [
    ...
    ("Ladder", [6.9831, 7.1805, 204.0919]),
    ("Ladder-W$_{INT4}$A$_{FP16}$", [1.806397709, 2.509997322, 197.1157714]),
    ("Ladder-W$_{NF4}$A$_{FP16}$", [1.838695201, 2.923462986, 201.2320358]),
    ("Ladder-W$_{FP8}$A$_{FP8}$", [3.52866644, 3.741222947, 196.9285823]),
    ("Ladder-W$_{MXFP8}$A$_{MXFP8}$", [3.667234483, 4.147930234, 255.9640476]),
    ("Ladder-W$_{INT1}$A$_{INT8}$", [0.503586429, 1.529837384, 135.626608]),
]
...
resnet_times_data = [
    ...
    ("Ladder", [1.1762, 16.0981]),
    ("Ladder-W$_{FP8}$A$_{FP8}$", [1.1762, 16.0086471]),
    ("Ladder-W$_{MXFP8}$A$_{MXFP8}$", [1.921283197, 16.60434647]),
    ("Ladder-W$_{INT1}$A$_{INT4}$", [1.1762, 13.99871434]),
]
...
shufflenet_times_data = [
    ...
    ("Ladder", [0.3483244, 4.837]),
    ("Ladder-W$_{FP8}$A$_{FP8}$", [0.3483244, 4.836]),
]
...
conformer_times_data = [
    ...
    ("Ladder", [2.0192, 117.6661]),
    ("Ladder-W$_{INT4}$A$_{INT8}$", [1.783731184, 113.4327309]),
    ("Ladder-W$_{INT4}$A$_{INT4}$", [1.695257581, 111.486313]),
]
...
vit_times_data = [
    ...
    ("Ladder", [0.9576, 6.3083]),
    ("Ladder-W$_{FP8}$A$_{FP8}$", [0.788025605, 6.344933633]),
    ("Ladder-W$_{INT4}$A$_{INT4}$", [0.9576, 6.344933633]),
]
