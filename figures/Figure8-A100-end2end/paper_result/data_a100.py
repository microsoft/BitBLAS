...
llama2_times_data = [
    ...
    ("Ladder", [1.0305, 1.3976, 33.7857]),
    ("Ladder-W$_{INT4}$A$_{FP16}$", [0.3437, 1.233927747, 29.94758645]),
    ("Ladder-W$_{NF4}$A$_{FP16}$", [0.5152, 1.3209758, 32.03680507]),
    ("Ladder-W$_{FP8}$A$_{FP8}$", [0.584, 1.163299968, 29.25529448]),
    ("Ladder-W$_{MXFP8}$A$_{MXFP8}$", [0.8467, 1.40422857, 36.6284164]),
    ("Ladder-W$_{INT1}$A$_{INT8}$", [0.1571, 0.717229423, 24.44975112]),
]
...
bloom_times_data = [
    ...
    ("Ladder", [2.845, 3.1374, 97.4431]),
    ("Ladder-W$_{INT4}$A$_{FP16}$", [0.83263518, 2.271361856, 90.92834427]),
    ("Ladder-W$_{NF4}$A$_{FP16}$", [1.306951993, 2.665507017, 106.2114859]),
    ("Ladder-W$_{FP8}$A$_{FP8}$", [1.514414341, 2.241219281, 91.7849889]),
    ("Ladder-W$_{MXFP8}$A$_{MXFP8}$", [1.983047948, 3.184281855, 105.1573525]),
    ("Ladder-W$_{INT1}$A$_{INT8}$", [0.324935987, 1.227464451, 67.368804]),
]
...
resnet_times_data = [
    ...
    ("Ladder", [1.1293, 7.9936]),
    ("Ladder_W$_{FP8}$A$_{FP8}$", [1.1293, 7.9936]),
    ("Ladder-W$_{MXFP8}$A$_{MXFP8}$", [2.090630394, 9.535129626]),
    ("Ladder_W$_{INT1}$A$_{INT4}$", [1.1293, 7.316121701]),
]
...
shufflenet_times_data = [
    ...
    ("Ladder", [0.3212, 3.3497]),
    ("Ladder_W$_{FP8}$A$_{FP8}$", [0.3212, 3.3531816]),
]
...
conformer_times_data = [
    ...
    ("Ladder", [2.06128, 60.2678]),
    ("Ladder-W$_{INT4}$A$_{INT8}$", [1.844756129, 56.28604248]),
    ("Ladder-W$_{INT4}$A$_{INT4}$", [1.707495592, 53.98872026]),
]
...
vit_times_data = [
    ...
    ("Ladder", [1.210912, 4.2378]),
    ("Ladder-W$_{FP8}$A$_{FP8}$", [1.210912, 4.080552524]),
    ("Ladder-W$_{INT4}$A$_{INT4}$", [1.210912, 3.49672571]),
]
