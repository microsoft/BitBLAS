...
import time
import logging
from configs import onnx_files
...
input_shape_dict = {
    "resnet-18": (128, 3, 224, 224),
    "resnet-50": (128, 3, 224, 224),
    "resnet-50-b1": (1, 3, 224, 224),
    "mobilenet-v2": (128, 3, 224, 224),
    "VGG-16": (128, 3, 224, 224),
    "NAFNet": (128, 3, 256, 256),
    "shufflenet": (128, 3, 224, 224),
    "shufflenet-b1": (1, 3, 224, 224),
    "squeezenet": (128, 3, 224, 224),
    "NeRF": (2073600, 64),
    "Conformer": (128, 512, 512),
    "vit": (128, 3, 224, 224),
    "vit-b1": (1, 3, 224, 224),
    "localvit": (128, 512, 512),
    "mobilevit": (128, 3, 256, 256),
    "opt-66b-1l": (16, 512),
    "llama2-70b-1l": (16, 512),
    "bloom-176b-1l": (16, 512),
}
