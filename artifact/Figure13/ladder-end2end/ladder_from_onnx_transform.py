...
parser.add_argument("--fast_decoding", action="store_true", help="Use fast decoding mode.")
...
def run(prefix, arch, async_propagate, fake_quant, quant_config, convert_int):
    ...
    if fake_quant > -1:
        mod = ladder.relay.transform.LadderFakeQuant(quant_type=fake_quant, quant_config=quant_config, convert_int=convert_int, convert_mxfp=args.convert_mxfp)(mod)
