...
/root/Ladder/artifact/Figure13_v100/welder_roller_end2end/../../baseline_framework/welder_nnfusion/build/src/tools/nnfusion/nnfusion /root/Ladder/artifact/Figure13_v100/welder_roller_end2end/../../models/llama_70b/llama2_70b_layer1_seq1_bs1/model.onnx -f onnx -ftune_output_file=model.json > get_model_block.log 2>&1
...
/root/Ladder/artifact/Figure13_v100/welder_roller_end2end/../../baseline_framework/welder_nnfusion/build/src/tools/nnfusion/nnfusion /root/Ladder/artifact/Figure13_v100/welder_roller_end2end/../../models/llama_70b/llama2_70b_layer1_seq1_bs1/model.onnx -f onnx -ftune_output_file=/dev/null -ftune_input_file=tuned.json -fwarmup_step=5 -frun_step=10 > codegen.log 2>&1
