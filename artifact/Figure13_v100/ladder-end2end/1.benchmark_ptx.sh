...
# FP16XINT4
python -u ladder_from_onnx_ptx.py --prebuilt_path $LADDER_CHECKPOINT_PATH/ladder_with_fake_dense_dequantize_fq_0_int_4_-1_bs1_seq1_ci_False 2>&1 | tee ptx_llama2-70b_b1_s1_q0_b4.log

python -u ladder_from_onnx_ptx.py --prebuilt_path $LADDER_CHECKPOINT_PATH/ladder_with_fake_dense_dequantize_fq_0_int_4_-1_bs1_seq4096_ci_False 2>&1 | tee ptx_llama2-70b_b1_s4096_q0_b4.log
...
# INT8XINT1
python -u ladder_from_onnx_ptx.py --prebuilt_path $LADDER_CHECKPOINT_PATH/ladder_with_fake_dense_dequantize_fq_0_int_1_-1_bs1_seq1_ci_True 2>&1 | tee ptx_llama2-70b_b1_s1_q0_b1_int.log

python -u ladder_from_onnx_ptx.py --prebuilt_path $LADDER_CHECKPOINT_PATH/ladder_with_fake_dense_dequantize_fq_0_int_1_-1_bs1_seq4096_ci_True 2>&1 | tee ptx_llama2-70b_b1_s4096_q0_b1_int.log
