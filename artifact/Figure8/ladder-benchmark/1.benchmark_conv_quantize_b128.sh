...
if [ $force_tune -eq 1 ]; then
    ...
    # vit
    # check out artifact/Figure8/ladder-benchmark/kernel_benchmark
    echo "Checking out artifact/Figure8/ladder-benchmark/kernel_benchmark for ViT FP8xFP8"
    echo "Checking out artifact/Figure8/ladder-benchmark/kernel_benchmark for ViT INT4xINT4"
