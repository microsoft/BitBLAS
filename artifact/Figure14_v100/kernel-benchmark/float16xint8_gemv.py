...
llm_float16xint8 = [
    (matmul_nt_dequantize_b, (1, 1024, 8192, "float16", "float16", "float16", 8, "int32", "uint", False, False, group_size, False, False), Matmul),
    (matmul_nt_dequantize_b, (1, 8192, 8192, "float16", "float16", "float16", 8, "int32", "uint", False, False, group_size, False, False), Matmul),
    (matmul_nt_dequantize_b, (1, 28672, 8192, "float16", "float16", "float16", 8, "int32", "uint", False, False, group_size, False, False), Matmul),
    (matmul_nt_dequantize_b, (1, 8192, 28672, "float16", "float16", "float16", 8, "int32", "uint", False, False, group_size, False, False), Matmul),
]
