...
_ = """
llama2_times_data =  [('PyTorch-Inductor', [-1, -1, -1]), ('ONNXRuntime', [-1, -1, -1]), ('TensorRT', [-1, -1, -1]), ('Welder', [-1, -1, -1]), ('vLLM', [-1, -1, -1]), ('vLLM-W$_{INT4}$A$_{FP16}$', [0, 0, 0]), ('Bitter', [-1, -1, -1]), ('Bitter-W$_{INT4}$A$_{FP16}$', [-1, -1, -1]), ('Bitter-W$_{NF4}$A$_{FP16}$', [-1, -1, -1]), ('Bitter-W$_{FP8}$A$_{FP8}$', [-1, -1, -1]), ('Bitter-W$_{MXFP8}$A$_{MXFP8}$', [-1, -1, -1]), ('Bitter-W$_{INT1}$A$_{INT8}$', [-1, -1, -1])]
bloom_times_data =  [('PyTorch-Inductor', [-1, -1, 0]), ('ONNXRuntime', [0, 0, 0]), ('TensorRT', [-1, -1, 0]), ('Welder', [-1, -1, 0]), ('vLLM', [0, 0, 0]), ('vLLM-W$_{INT4}$A$_{FP16}$', [0, 0, 0]), ('Bitter', [-1, -1, 0]), ('Bitter-W$_{INT4}$A$_{FP16}$', [-1, -1, 0]), ('Bitter-W$_{NF4}$A$_{FP16}$', [-1, -1, 0]), ('Bitter-W$_{FP8}$A$_{FP8}$', [-1, -1, 0]), ('Bitter-W$_{MXFP8}$A$_{MXFP8}$', [-1, -1, 0]), ('Bitter-W$_{INT1}$A$_{INT8}$', [-1, -1, 0])]
resnet_times_data =  [('PyTorch-Inductor', [-1, -1]), ('ONNXRuntime', [-1, -1]), ('TensorRT', [-1, -1]),  ('AMOS', [-1, -1]),('TensorIR', [-1, -1]), ('Welder', [-1, -1]), ('Bitter', [-1, -1]), ('Bitter_W$_{FP8}$A$_{FP8}$', [-1, -1]), ('Bitter-W$_{MXFP8}$A$_{MXFP8}$', [-1, -1]), ('Bitter_W$_{INT1}$A$_{INT4}$', [-1, -1])]
shufflenet_times_data =  [('PyTorch-Inductor', [-1, -1]), ('ONNXRuntime', [-1, -1]), ('TensorRT', [-1, -1]), ('AMOS', [-1, -1]), ('TensorIR', [-1, -1]), ('Welder', [-1, -1]), ('Bitter', [-1, -1]), ('Bitter_W$_{FP8}$A$_{FP8}$', [-1, -1])]
conformer_times_data =  [('PyTorch-Inductor', [-1, -1]), ('ONNXRuntime', [-1, -1]), ('TensorRT', [-1, -1]), ('AMOS', [0, 0]), ('TensorIR', [0, 0]), ('Welder', [-1, -1]), ('Bitter', [-1, -1]), ('Bitter-W$_{INT4}$A$_{INT8}$', [-1, -1]), ('Bitter-W$_{INT4}$A$_{INT4}$', [-1, -1])]
vit_times_data =  [('PyTorch-Inductor', [-1, -1]), ('ONNXRuntime', [-1, -1]), ('TensorRT', [-1, -1]), ('AMOS', [0, 0]), ('TensorIR', [-1, -1]), ('Welder', [-1, -1]), ('Bitter', [-1, -1]), ('Bitter-W$_{FP8}$A$_{FP8}$', [-1, -1]), ('Bitter-W$_{INT4}$A$_{INT4}$', [-1, -1])]
"""
