...
if [ $force_tune -eq 1 ]; then
 # resnet
    ...
    # Conformer
    ## int8*int4
    python -u ladder_with_fake_conv_dequantize.py --async_propagation --prefix $MODEL_PATH/Conformer-b1 --fake_quant 0 --bits 4 --format int --convert_int 2>&1 | tee logs/Conformer-b1_int8xint4.log
    ## int4*int4
