...
/usr/bin/python -u ./ladder_with_fake_dense_dequantize.py --async_propagation --batch 32 --seq_len 1 --fake_quant 0 --bits 4  2>&1 | tee logs/llama2/llama2-70b_b32_s1_q0_b4.log

/usr/bin/python -u ./ladder_with_fake_dense_dequantize.py --async_propagation --batch 32 --seq_len 1 --fake_quant 0 --bits 1 --convert_int  2>&1 | tee logs/llama2/llama2-70b_b32_s1_q0_b1_int.log

/usr/bin/python -u ./ladder_with_fake_dense_dequantize.py --async_propagation --batch 32 --seq_len 1 --fake_quant 0 --bits 8 --convert_int 2>&1 | tee logs/llama2/llama2-70b_b32_s1_q0_b8_int.log
...
/usr/bin/python -u ./ladder_with_fake_dense_dequantize.py --async_propagation --batch 128 --seq_len 1 --fake_quant 0 --bits 4 --format nf 2>&1 | tee logs/llama2/llama2-70b_b128_s1_q0_nf4.log
...
/usr/bin/python -u ./ladder_with_fake_dense_dequantize.py --async_propagation --batch 128 --seq_len 1 --fake_quant 0 --bits 8 --format fp_e5m2 2>&1 | tee logs/llama2/llama2-70b_b128_s1_q0_fp_e5m2.log
...
/usr/bin/python -u ./ladder_with_fake_dense_dequantize.py --async_propagation --batch 128 --seq_len 1 --fake_quant 0 --bits 8 --format mxfp 2>&1 | tee logs/llama2/llama2-70b_b128_s1_q0_mxfp8.log
