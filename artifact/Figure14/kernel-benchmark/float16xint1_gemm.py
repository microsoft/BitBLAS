...
llm_float16xint1 = [
    (matmul_nt_dequantize_b_propagate_a_propagate_b, (32, 8192, 22016, "float16", "float16", "float16", 1, "int8", "uint", False, False, group_size, True, False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b, (32, 8192, 8192, "float16", "float16", "float16", 1, "int8", "uint", False, False, group_size, True, False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b, (32, 28672, 8192, "float16", "float16", "float16", 1, "int8", "uint", False, False, group_size, True, False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b, (32, 8192, 28672, "float16", "float16", "float16", 1, "int8", "uint", False, False, group_size, True, False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b, (4096, 8192, 22016, "float16", "float16", "float16", 1, "int8", "uint", False, False, group_size, True, False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b, (4096, 8192, 8192, "float16", "float16", "float16", 1, "int8", "uint", False, False, group_size, True, False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b, (4096, 28672, 8192, "float16", "float16", "float16", 1, "int8", "uint", False, False, group_size, True, False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b, (4096, 8192, 28672, "float16", "float16", "float16", 1, "int8", "uint", False, False, group_size, True, False), Matmul),
]
