...
llm_float16xint2 = [
    (matmul_nt_dequantize_b, (1, 1024, 8192, "float16", "float16", "float16", 2, "int8", "uint", False, False, group_size, True, False), Matmul),
    (matmul_nt_dequantize_b, (1, 8192, 8192, "float16", "float16", "float16", 2, "int8", "uint", False, False, group_size, True, False), Matmul),
    (matmul_nt_dequantize_b, (1, 28672, 8192, "float16", "float16", "float16", 2, "int8", "uint", False, False, group_size, True, False), Matmul),
    (matmul_nt_dequantize_b, (1, 8192, 28672, "float16", "float16", "float16", 2, "int8", "uint", False, False, group_size, True, False), Matmul),
]
