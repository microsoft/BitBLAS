...
llm_shape_fp16xfp16 = [    
    (matmul_nt, (1, 1024, 8192, "float16", "float16")),
    (matmul_nt, (1, 8192, 8192, "float16", "float16")),
    (matmul_nt, (1, 28672, 8192, "float16", "float16")),
    (matmul_nt, (1, 8192, 28672, "float16", "float16")),
]
# fmt:on
