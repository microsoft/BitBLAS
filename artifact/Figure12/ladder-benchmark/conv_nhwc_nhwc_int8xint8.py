...
def reshape(_N, _H, _W, _C, wmma_m, wmma_n):
    M = _N * _H * _W
    N = _C
    C = te.placeholder((M // wmma_m, N // wmma_n, wmma_m, wmma_n), name='C', dtype='int8')
...
def reshape_nhwc(_N, _H, _W, _C, wmma_m, wmma_n):
    C = te.placeholder((_N // wmma_m, _H, _W, _C // wmma_n, wmma_m, wmma_n), name='C', dtype='int8')
    C_reshpae = te.compute(
        (_N, _H, _W, _C),
...
def bias(_N, _H, _W, _C):
    A = te.placeholder((_N, _H, _W, _C), name='A', dtype='int8')
    B = te.placeholder((_C,), name='B', dtype='int8')
    C = te.compute(
        (_N, _H, _W, _C),
...
def add_conv(_N, _H, _W, _C):
    A = te.placeholder((_N, _H, _W, _C), name='A', dtype='int8')
    B = te.placeholder((_N, _H, _W, _C), name='B', dtype='int8')
    C = te.compute(
        (_N, _H, _W, _C),
...
def layout_transform_with_func(_N, _H, _W, _C, wmma_m = 16, wmma_n = 16, func=None):
    def fcompute(*args):
        ...
        return A[new_index]
    A = te.placeholder((_N // wmma_m, _H, _W, _C // wmma_n, wmma_m, wmma_n), name='A', dtype='int8')
    B = te.compute(
        (_N // wmma_m, _H, _W, _C // wmma_n, wmma_m, wmma_n),
        fcompute,
        name='B'
