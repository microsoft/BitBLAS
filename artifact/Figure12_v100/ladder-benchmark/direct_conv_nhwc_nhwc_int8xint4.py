...
def tvm_callback_cuda_postproc(code):
    # print(code)
    code = code.replace("""make_int2((signed char)0, (signed char)0, (signed char)0, (signed char)0, (signed char)0, (signed char)0, (signed char)0, (signed char)0)""", """make_int2(0, 0)""")
    return code
