...
llm_shapes = [
    ...
    # square test
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (16384, 16384, 16384, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    # # BLOOM-176B
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 43008, 14336, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 14336, 14336, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 57344, 14336, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 14336, 57344, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    # # OPT-65B
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 9216, 9216, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 36864, 9216, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 9216, 36864, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 22016, 8192, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    # # LLAMA-70B/65B
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 8192, 22016, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 8192, 8192, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 28672, 8192, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
    (matmul_nt_dequantize_b_propagate_a_propagate_b,
     (8192, 8192, 28672, "float16", "float16", "float16", 4, "int8", "nf", True, 128, False,
      False), Matmul),
]
