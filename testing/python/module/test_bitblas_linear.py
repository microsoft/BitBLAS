...
def test_correctness_weight_only_dequantize():
    ...
    correctness_weight_only_dequantize(1, 1024, 1024, False, "uint4", -1, False, False, None)
    correctness_weight_only_dequantize(1024, 1024, 1024, False, "uint4", -1, False, False, None)
    ...
    correctness_weight_only_dequantize(1024, 1024, 1024, False, "uint2", 128, True, True,
                                       "original")
