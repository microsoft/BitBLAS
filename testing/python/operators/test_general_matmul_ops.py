...
@pytest.mark.parametrize(
    "M,N,K,A_dtype,W_dtype,accum_dtype,out_dtype,with_bias",
    [
        (1, 768, 768, "float16", "uint4", "float16", "float16", False),
        (1, 768, 768, "float16", "int4", "float16", "float16", False),
        (768, 768, 768, "float16", "uint4", "float16", "float16", False),
        (768, 768, 768, "float16", "int4", "float16", "float16", False),
    ],
)
